...
class Encoder(torch.nn.Module):
    ...
    def forward(self, batch_embedding_dict, batch_edge_index_dict):
        ...
        batch_embedding_dict = self.conv2(self.lin2(batch_embedding_dict), batch_edge_index_dict) 
        batch_embedding_dict = batch_embedding_dict.relu()
        batch_embedding_dict = self.conv3(self.lin3(batch_embedding_dict), batch_edge_index_dict) 
        batch_embedding_dict = batch_embedding_dict.relu()
