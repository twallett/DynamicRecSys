...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, hidden_channels, output_channels):
        super().__init__()
        self.conv1 = CGConv(channels=(hidden_channels, output_channels))
        self.conv2 = CGConv(channels=(hidden_channels, output_channels))
        self.conv3 = CGConv(channels=(hidden_channels, output_channels))
...
class RecommendationSystem(torch.nn.Module):
    ...
    def __init__(self, data, hidden_channels, output_channels):
        super().__init__()
        self.encoder = Encoder(hidden_channels=hidden_channels, output_channels = output_channels)
